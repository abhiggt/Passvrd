...
#Function for Opening Vault
def vault():
	call(['python','vault.py'])
	vault()
       
save_button=Button(root, text="Copy to Clipboard",fg="#5ced9b",bg='#111111',font=("Product Sans",13),command=copyto,compound = LEFT) 
save_button.grid(row=6,column=2,padx=5, pady=7)
ave_button=Button(root, text="Open Vault",fg="#5ced5b",bg='#111111',font=("Product Sans",13),command=vault,compound = LEFT) 
ave_button.grid(row=7,column=2,padx=2, pady=7)
